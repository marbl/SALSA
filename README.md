...
Since Hi-C reads and alignments contain experimental artifacts, the alignments needs some postprocessing. We, along with Arima genomics are going to soon release a Hi-C read alignment pipeline. Stay tuned!
